class Solution {
    ...
    static class SegmentTree {
        ...
        private void update(int treeIndex, int arrStart, int arrEnd, int updateStart, int updateEnd, int val) {
            ...
            update(treeIndex * 2 + 1, arrStart, mid, updateStart, updateEnd, val);
            update(treeIndex * 2 + 2, mid + 1, arrEnd, updateStart, updateEnd, val);
        ...
        private int query(int treeIndex, int arrStart, int arrEnd, int index) {
            ...
            if (index <= mid) {
                return query(treeIndex * 2 + 1, arrStart, mid, index);
            } else {
                return query(treeIndex * 2 + 2, mid + 1, arrEnd, index);
            }
        }
    }
